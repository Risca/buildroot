...
ifneq ($(BR2_TOOLCHAIN_BUILDROOT_GCCGO),y)
HOST_GCC_FINAL_EXCLUDES += libgo/*
endif
...
define HOST_GCC_FINAL_INSTALL_LIBGO
	-cp -dpf $(HOST_GCC_FINAL_GCC_LIB_DIR)/libgo* \
		$(STAGING_DIR)/lib/
	-cp -dpf $(HOST_GCC_FINAL_GCC_LIB_DIR)/libgo* \
		$(TARGET_DIR)/lib/
endef

HOST_GCC_FINAL_POST_INSTALL_HOOKS += HOST_GCC_FINAL_INSTALL_LIBGO
endif
